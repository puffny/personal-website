...
export const siteData = {
  person: {
    ...
    heroPhotoSrc: "/assets/hero-photo.webp",
    backgroundVideo: "https://puff.oss-cn-hangzhou.aliyuncs.com/portfolio-demo/assets/hero-background.mp4?v=20260629-tone",
  },
  heroStats: [
    ...
    items: [
      {
        ...
        proof: "# 浙里报账 / 天目数智平台",
        image: "/assets/figma-core-01.webp",
      ...
      },
      {
        ...
        image: "/assets/figma-core-02.webp",
      ...
      },
      {
        ...
        image: "/assets/figma-core-03.webp",
  ...
  tools: [
    ["Photoshop", "/assets/tool-icons/photoshop.svg"],
    ["Lightroom", "/assets/tool-icons/lightroom.svg"],
    ["Illustrator", "/assets/tool-icons/illustrator.svg"],
    ["After Effects", "/assets/tool-icons/after-effects.svg"],
    ["Figma", "/assets/tool-icons/figma.svg"],
    ["Sketch", "/assets/tool-icons/sketch.svg"],
    ["Blender", "/assets/tool-icons/blender.svg"],
    ["GPT", "/assets/tool-icons/openai.svg"],
    ["Codex", "/assets/tool-icons/codex.svg"],
    ["Claude", "/assets/tool-icons/claude.svg"],
    ["Cursor", "/assets/tool-icons/cursor.svg"],
    ["Lovart", "/assets/tool-icons/lovable.svg"],
    ["Netlify", "/assets/tool-icons/netlify.svg"],
  ],
  selectedWorks: {
    ...
    items: [
      {
        ...
        image: "/assets/figma-project-tianmu.webp",
      ...
      },
      {
        ...
        image: "/assets/figma-project-baozhang.webp",
        imageAlt: "浙里报账项目展示",
        metrics: [
  ...
  aiLab: {
    ...
    layers: [
      { src: "/assets/ailab_1.webp", alt: "Figma设计稿与内容整理界面", className: "ai-lab-layer-1" },
      { src: "/assets/ailab_2.webp", alt: "ChatGPT文件整理工作区", className: "ai-lab-layer-2" },
      { src: "/assets/ailab_3.webp", alt: "AI协作对话与方案记录", className: "ai-lab-layer-3" },
      { src: "/assets/ailab_4.webp", alt: "生成式影像实验界面", className: "ai-lab-layer-4" },
      { src: "/assets/ailab_5.webp", alt: "Codex代码实现界面", className: "ai-lab-layer-5" },
    ],
  ...
  projects: {
    tianmu: {
      ...
      ariaLabel: "天目数智案例图片流",
      feedImages: [
        "/assets/tianmu-feed/tianmu-01.webp",
        "/assets/tianmu-feed/tianmu-02.webp",
        "/assets/tianmu-feed/tianmu-03.webp",
        "/assets/tianmu-feed/tianmu-04.webp",
        "/assets/tianmu-feed/tianmu-05.webp",
        "/assets/tianmu-feed/tianmu-06.webp",
        "/assets/tianmu-feed/tianmu-07.webp",
        "/assets/tianmu-feed/tianmu-08.webp",
        "/assets/tianmu-feed/tianmu-09.webp",
        "/assets/tianmu-feed/tianmu-10.webp",
        "/assets/tianmu-feed/tianmu-11.webp",
        "/assets/tianmu-feed/tianmu-12.webp",
        "/assets/tianmu-feed/tianmu-13.webp",
        "/assets/tianmu-feed/tianmu-14.webp",
        "/assets/tianmu-feed/tianmu-15.webp",
        "/assets/tianmu-feed/tianmu-16.webp",
      ],
      title: "天目数智平台管理系统",
      eyebrow: "后台管理系统",
      image: "/assets/天目数智后台截图示意.webp",
    ...
    baozhang: {
      ...
      ariaLabel: "浙里报账案例图片流",
      feedImages: [
        "/assets/baozhang-feed/baozhang-01.webp",
        "/assets/baozhang-feed/baozhang-02.webp",
        "/assets/baozhang-feed/baozhang-03.webp",
        "/assets/baozhang-feed/baozhang-04.webp",
        "/assets/baozhang-feed/baozhang-05.webp",
        "/assets/baozhang-feed/baozhang-06.webp",
        "/assets/baozhang-feed/baozhang-07.webp",
        "/assets/baozhang-feed/baozhang-08.webp",
        "/assets/baozhang-feed/baozhang-09.webp",
        "/assets/baozhang-feed/baozhang-10.webp",
        "/assets/baozhang-feed/baozhang-11.webp",
        "/assets/baozhang-feed/baozhang-12.webp",
        "/assets/baozhang-feed/baozhang-13.webp",
        "/assets/baozhang-feed/baozhang-14.webp",
        "/assets/baozhang-feed/baozhang-15.webp",
      ],
      summary:
    ...
    senben: {
      ...
      beforeAfter: [
        {
          label: "Before",
          image: "/assets/senben-plan-before.webp",
          alt: "森本 App 计划模块旧方案 UI",
          caption: "旧方案以卡片和列表承载内容，信息明确，但场景感和记忆点较弱。",
        },
        {
          label: "After",
          image: "/assets/senben-plan-after.webp",
      ...
      gallery: [
        { image: "/assets/senben-home-news.webp", alt: "森本 App 首页新闻页面", caption: "首页新闻" },
        { image: "/assets/senben-plan.webp", alt: "森本 App 计划模块页面", caption: "计划模块" },
        { image: "/assets/senben-my-page.webp", alt: "森本 App 我的页面", caption: "我的页面" },
      ],
      figmaPrototype: {
        title: "森本新闻 App 交互原型",
        embed:
  ...
  contact: {
    ...
    website: "puffny.cn",
    copyright: "© 2026 Liang Huifeng / Puffny. All rights reserved.",
  },
};
