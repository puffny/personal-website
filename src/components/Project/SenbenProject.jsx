  ...
  return (
    <>
      ...
      <main className="senben-page">
        ...
        <section
          className="senben-section senben-before-after"
          aria-labelledby="senben-before-after-title"
        >
        ...
        <section
          className="senben-section senben-decision"
          aria-labelledby="senben-decision-title"
        >
          <div className="senben-section-copy">
        ...
        <section
          className="senben-section senben-preview"
          aria-labelledby="senben-preview-title"
        >
          <div className="senben-section-copy">
          ...
          <div className="senben-preview-grid">
            <div
              className="senben-phone-gallery"
              aria-label="森本 App 最终页面展示"
            >
            ...
            <div className="senben-prototype">
              <div className="figma-prototype">
                <iframe
                  ...
                  src={project.figmaPrototype.embed}
                  allowFullScreen
                />
              </div>
              <a
                className="figma-prototype-link"
                href={project.figmaPrototype.url}
                target="_blank"
                rel="noreferrer"
              >
                打开 Figma 原型
